...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # CUSTOM FIELDS:
    is_laboratory = models.BooleanField(_('laboratory status'), default=False)
    ...
    source = models.CharField(
        _('Source'), choices=SOURCES, default=SOURCES.web, max_length=20)
    ...
    def email_user(self, subject, message, from_email=None, **kwargs):
        """
        Overridden for asynchronous sending an email to User.
        """
